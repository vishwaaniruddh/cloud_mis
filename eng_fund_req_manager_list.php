                                                ...
                                                ?>
                                                    <tr <? if ($aging_day > 3 && $status != 0) { ?> style="background:#fe5d70c2;color:white;" <? } if ($status == 0) { ?> style="background:#0ac282;color:white;" <?  } elseif ($status >1 ) {  ?> style="background:#6c757d;color:white;" <? } elseif ($status == 1) {  ?> style="background:yellow;color:black;" <? }  ?>>
                                                        ...
                                                        <td id="result_<?php echo $i; ?>">
                                                            <?php if($status==2){ ?>
                                                            <a data-toggle="modal" data-id="<?php echo $id; ?>" data-reqamt="<?php echo $req_amt; ?>" data-appamt="<?php echo $bm_approved_amt; ?>" class="open-AddBookDialog btn btn-danger" href="#myModal">Pending</a>
                                                            <?php }else{ ?>
                                                            Approved
                                                            <?php } ?>
            ...
            <div class="card-block">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label>BM Approved Amount</label>
                            <input type="text" readonly id="bm_approved_amt" class="form-control">
                        </div>
                        <div class="col-sm-4">
...
$(document).on("click", ".open-AddBookDialog", function () {
     ...
     $(".modal-body #bm_approved_amt").val( appAmt );
     $("#approved_amt").attr({
       "max" : reqAmt,
       "min" : 1
    });
...
$('#myModal form').on('submit', function (e) {
       ...
       if(parseInt(app_amt)>=parseInt(req_amt)){
        ...
        //   swal("Warning", "Approved Amount must be less than or equal to Requested Amount !", "error"); 
                    return false;
       }
      ...
      if(err==0){
          ...
          $.ajax({
            type: 'post',
            url: 'eng_fund_approved_by_manager.php',
        ...
        //    $('#remarks_'+res[1]).html(res[0]);
          ...
          //  $('#checkbox_'+res[1]).css('display','none');
           ...
           setTimeout(function(){ 
               window.location.href="eng_fund_req_manager_list.php";
           }, 3000);
