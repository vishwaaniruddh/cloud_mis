...
values('".$atmid."','".$bank."','".$customer."','".$zone."','".$city."','".$state."','".$location."','".$call_receive."','".$remarks."','Pending','".$created_by."','".$created_at."','".$branch."','".$bm."','".$call_type."','".$serviceExecutive."')";
...
if(mysqli_query($con,$statement)){
    ...
    if($call_type=='Service'){
        ...
        $status ='footage_pending';     
        
        $call_receive = $_REQUEST['call_receive'];
        
        $footage_requestBy = $_REQUEST['footage_requestBy'];
        $footage_format = $_REQUEST['footage_format'];
        
        $footage_txn_time = $_REQUEST['footage_txn_time'];
