...
<form>
    <div class="row">
        ...
        <div class="col-sm-12">
            <label>
                <input type="checkbox" id="fill_full_amount"> Approve Full Amount
            </label>
        </div>
...
<script>
    ...
    $('#myModal form').on('submit', function(e) {
        ...
        if (err === 0) {
            ...
            $.ajax({
                type: 'post',
                url: 'eng_fund_approved_by_bm_manager.php',
    ...
    if (response.status === 200) {
        ...
        setTimeout(function() {
            window.location.href = "eng_fund_req_account_manager_list.php";
        }, 3000);
    } else {
