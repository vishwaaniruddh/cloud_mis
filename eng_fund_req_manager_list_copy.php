                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="multiselect_status" class="form-control" name="status[]" multiple="multiple">
                                                <?php
                                                $i = 0;
                                                $status_sql = mysqli_query($con, "select status_code,status_name from engfund_status where status='1'");
                                                ...
                                                ?>
                                                    <option value="<?php echo $status_sql_result['status_code']; ?>" <?php  if(isset($_REQUEST['status'])) { 
                                                    ...
                                                    if(in_array($status_sql_result['status_code'],$_REQUEST['status'])){
                                                        ...
                                                        if($status_sql_result['status_name']!='Close'){
                                                            echo 'selected';
                                                        }
                                                    }
                                                    ?>
                                                ...
                                                ?>
                                                    <tr <? if ($aging_day > 3 && $status != 0) { ?> style="background:#fe5d70c2;color:white;" <? } if ($status == 0) { ?> style="background:#0ac282;color:white;" <?  } elseif ($status >1 ) {  ?> style="background:#6c757d;color:white;" <? } elseif ($status == 1) {  ?> style="background:yellow;color:black;" <? }  ?>>
                                                        ...
                                                        <td id="result_<?php echo $i; ?>">
                                                            <?php if($status==1){ ?>
                                                            <a data-toggle="modal" data-id="<?php echo $id; ?>" data-reqamt="<?php echo $req_amt; ?>" class="open-AddBookDialog btn btn-danger" href="#myModal">Pending</a>
                                                            <?php }else{ ?>
                                                            Approved
                                                            <?php } ?>
