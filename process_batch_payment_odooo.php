...
$sql = mysqli_query($con, "SELECT * FROM eng_fund_request WHERE isPaymentProcessed = 0 and batch_id='".$batch_id."' and approved_amount>0");
$data = [];
...
try {
        ...
        $mail->SMTPAuth   = true;                                 
        $mail->Username   = 'bot@comforttechno.com';               
    ...
    // $mail->setFrom('tickets@sarsspl.com', 'Bot');
    $mail->addAddress('bot@comforttechno.com'); // Recipient email
