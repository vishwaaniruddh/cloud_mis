                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="engineer" class="form-control">
                                                ...
                                                <option value="<?php echo $eng_sql_result['id'];?>" <? if($_REQUEST['engineer']==$eng_sql_result['id']){ echo 'selected';} ?>>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" name="fromdt" class="form-control" value="<? if ($_REQUEST['fromdt']) { echo  $_REQUEST['fromdt']; } else { echo '2024-01-01'; } ?>">
                                        </div>
                                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div style="display:flex;justify-content:space-around;">
                                        <h5 style="text-align:center;">Fund Requested Detailed Report - <p>Total Records- <? echo $total_records ;  ?></p></h5>
                                                ...
                                                <?php
                                                    ...
                                                    while ($sql_result = mysqli_fetch_assoc($sql_app)) {
                                                       $i++;
                                                        ...
                                                        if($status==2){
                                                            $current_status = 'BM Manager_Approved';
                                                        }
                                                        if($status==3){
                                                     ...
                                                     //   $bm_approved_amt = $sql_result['approved_amount'];
                                                        $approved_amt = $sql_result['approved_amount'];
                                                        
                                                ?>
                                                    <tr <? if ($aging_day > 3 && $status != 0) { ?> style="background:#fe5d70c2;color:white;" <? } if ($status == 0) { ?> style="background:#0ac282;color:white;" <?  } elseif ($status >1 ) {  ?> style="background:#6c757d;color:white;" <? } elseif ($status == 1) {  ?> style="background:yellow;color:black;" <? }  ?>>
                                                        <!--<td><? echo ++$i; ?></td>-->
                                                        ...
                                                        <td style=" background:white;    border: 1px solid black; ">
                                                            <a style=" text-decoration: none; font-weight: 700;" target="_blank" href="mis_details.php?id=<? echo $id; ?>" <? if ($aging_day > 3 && $status != 0) { ?> style="color:white" <? } ?>>
                                                        ...
                                                        <td> <? echo ( $sql_result['requested_amount'] ? $sql_result['requested_amount']: '-'); ?> </td>
                                                        <td> <? echo ($sql_result['approved_amount'] ? $sql_result['approved_amount']: '-');?> </td>
                                                        ...
                                                        <td><? echo ($diff->format("%a days") ? $diff->format("%a days"): '-'); ?></td>
                                                         <td> 
                                                            	<div class="thumbnail">
                													<div class="thumb">
                														<a href="<? echo ($sql_result['img'] ? $sql_result['img']: '-');?>" data-lightbox="gallery" > <img src="<? echo ($sql_result['img'] ? $sql_result['img']: '-');?>" style="width:100px;" class="img-fluid img-thumbnail"> </a>
                													</div>
                												</div>
                                                        </td>
                                                        <td id="result_<?php echo $i; ?>">
                                                            <?php if($status==5){ ?>
                                                            <a data-toggle="modal" data-id="<?php echo $id; ?>" data-reqamt="<?php echo $req_amt; ?>" data-appamt="<?php echo $approved_amt; ?>" class="open-AddBookDialog btn btn-danger" href="#myModal">Pending</a>
                                                            <?php }else{ ?>
                                                            Approved
                                                            <?php } ?>
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" readonly id="approved_amt" name="approved_amt" class="form-control">
                        </div>
...
$('#myModal form').on('submit', function (e) {
       ...
       if(fund_remarks==''){
          ...
          // swal("Warning", "Remarks must be required :)", "error"); 
                    return false;
       }
      ...
      if(err==0){
          ...
          $.ajax({
            type: 'post',
            url: 'eng_fund_approved_by_account.php',
        ...
        //    $('#remarks_'+res[1]).html(res[0]);
          ...
          //  $('#checkbox_'+res[1]).css('display','none');
            ...
            $('#myModal').modal('toggle'); 
             ...
             swal("Good job!", "Updated Done !", "success");

           setTimeout(function(){ 
               window.location.href="eng_fund_req_account_list.php";
           }, 3000);
