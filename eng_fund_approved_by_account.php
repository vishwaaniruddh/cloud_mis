...
if($_SESSION['username']){ 
   ...
   // $approved_amt = $_POST['approved_amt'];
    ...
    $updatesql = "update eng_fund_request SET req_status= 6 WHERE id='".$fund_id."'"; 
    ...
    $insertfundsql = "insert into eng_fund_request_history(fundreq_id, requested_amount,approved_amount,action_by,status,created_at,updated_at) values('".$fund_id."','".$requested_amt."','".$approved_amt."','".$action_by."',6,'".$created_at."','".$created_at."')" ; 
