                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            if ($mis_status == 'schedule' || $mis_status == 'schedule ' || $mis_status == 'acknowledge_fund'  || $mis_status == 'fund_request_rejected' || $mis_status == 'fund_transfered' || $mis_status == 'fund_level_1_pending') { ?>
                                                <option value="">Select</option>
                                                <option value="material_requirement">Material Requirement</option>
                                                <option value="permission_require">Permission Required</option>
                                                <option value="fund_required"> Fund Requirement</option>
